...
jQuery(document).ready(function($) {
    ...
    sizeDescription.append("<li class='airBuddyDescription airBuddySize-s-m'>Misura del petto<br class='br-hide'> 80 ~ 100 cm</li>");
    sizeDescription.append("<li class='airBuddyShow airBuddyDescription airBuddySize-l-xl'>Misura del petto<br class='br-hide'> 100 ~ 112 cm</li>");
    sizeDescription.append("<li class='airBuddyShow airBuddyDescription airBuddySize-2xl-3xl'>Misura del petto<br class='br-hide'> 112 ~ 125 cm</li>");
    
    var smallButton = $("a[data-value='s-m-it']");
    var largeButton = $("a[data-value='l-xl-it']");
    var extraLargeButton = $("a[data-value='2xl-3xl-it']");
...
// HARNESS SIZE - 2nd DIVER
    ...
    sizeDescription.append("<li class='airBuddyShow airBuddyDescription airBuddySize-sm'>Misura del petto<br class='br-hide'> 80 ~ 100 cm</li>");
    sizeDescription.append("<li class='airBuddyShow airBuddyDescription airBuddySize-lxl'>Misura del petto<br class='br-hide'> 100 ~ 112 cm</li>");
    sizeDescription.append("<li class='airBuddyShow airBuddyDescription airBuddySize-2xl3xl'>Misura del petto<br class='br-hide'> 112 ~ 125 cm</li>");
	sizeDescription.find("li:nth-child(2)").addClass('active');
    var smallButtonTwo = $("a[data-value='sm-it']");
    var largeButtonTwo = $("a[data-value='lxl-it']");
    var extraLargeButtonTwo = $("a[data-value='2xl3xl-it']");
    var noButton = $("a[data-value='no-it']");
...
// Dive Flag Type
    ...
    diveFlagDescription.append("<li class='airBuddyDescription airBuddyRedWhite'>Nord America, <br class='br-hide'>Italia, Svizzera</li>");
    diveFlagDescription.append("<li class='airBuddyShow airBuddyDescription airBuddyAlpha'>Internazionale</li>");
...
// Charger Plug
    ...
    chargerDescription.append("<li class='airBuddyDescription airBuddyB'>USA, Canada, Messico, <br class='br-hide'>Giappone, Thailandia, Taiwan</li>");
    chargerDescription.append("<li class='airBuddyShow airBuddyDescription airBuddyI'>Australia, Nuova Zelanda, <br class='br-hide'>Cina, Argentina, Figi</li>");
    chargerDescription.append("<li class='airBuddyShow airBuddyDescription airBuddyCef'>La maggior parte dell'UE, parti dell'Asia, <br class='br-hide'>parti del Sud America</li>");
    chargerDescription.append("<li class='airBuddyShow airBuddyDescription airBuddyG'>Regno Unito, Irlanda, Malta, Hong Kong, <br class='br-hide'>Singapore, Medio Oriente</li>");
    chargerDescription.append("<li class='airBuddyShow airBuddyDescription airBuddyJ'>Svizzera</li>");
    chargerDescription.append("<li class='airBuddyShow airBuddyDescription airBuddyH'>Israele</li>");
    chargerDescription.append("<li class='airBuddyShow airBuddyDescription airBuddyM'>Sud Africa, India</li>");
...
// Language
    ...
    languageDescription.append("<li class='airBuddyDescription airBuddyEng'>Inglese</li>");
    languageDescription.append("<li class='airBuddyShow airBuddyDescription airBuddyGer'>Tedesco</li>");
    languageDescription.append("<li class='airBuddyShow airBuddyDescription airBuddyFra'>Francese</li>");
    languageDescription.append("<li class='airBuddyShow airBuddyDescription airBuddyEsp'>Spagnolo</li>");
    languageDescription.append("<li class='airBuddyShow airBuddyDescription airBuddyIta'>Italiano</li>");
    languageDescription.append("<li class='airBuddyShow airBuddyDescription airBuddyCze'>Ceco</li>");

    var engButton = $("a[data-value='eng-it']");
    var gerButton = $("a[data-value='ger-it']");
    var fraButton = $("a[data-value='fra-it']");
    var espButton = $("a[data-value='esp-it']");
    var itaButton = $("a[data-value='ita-it']");
    var czeButton = $("a[data-value='cze-it']");
...
// DIVER SETUP
    ...
    diverDescription.append("<li class='airBuddyDescription airBuddySingle'>Un subacqueo<br class='br-hide'> fino a 12m</li>");
    diverDescription.append("<li class='airBuddyShow airBuddyDescription airBuddyBuddy'>Due subacquei<br class='br-hide'> fino a 6&6m</li>");
    diverDescription.append("<li class='airBuddyShow airBuddyDescription airBuddyCombo'>Un subacqueo fino a 12 m o<br class='br-hide'> due subacquei fino a 6&6m</li>");
    diverDescription.append("<li class='airBuddyShow airBuddyDescription airBuddyDuo'>Due subacquei<br class='br-hide'> fino a 12m</li>");

    var singleButton = $("a[data-value='single-it']");
    var buddyButton = $("a[data-value='buddy-it']");
    var comboButton = $("a[data-value='combo-it']");
    var duoButton = $("a[data-value='duo-it']");
    ...
    var languageValues = ["eng-it","ger-it","fra-it","esp-it","ita-it","cze-it"];
    ...
    function applyDiverSetupUI() {
        ...
        if (setup === "single-it") {
            ...
            if (harness1st) {
                if (harness1st === "s-m-it") $(harnessArr[0]).css("display","list-item");
                else if (harness1st === "l-xl-it") $(harnessArr[1]).css("display","list-item");
                else if (harness1st === "2xl-3xl-it") $(harnessArr[2]).css("display","list-item");
            }
            $(harnessTwoArr[0]).css("display","list-item");
        ...
        } else if (setup === "buddy-it") {
            turnOffElements(harnessTwoArr);
            if (harness2nd === "sm-it") $(harnessTwoArr[0]).css("display","list-item");
            else if (harness2nd === "lxl-it") $(harnessTwoArr[1]).css("display","list-item");
            else if (harness2nd === "2xl3xl-it") $(harnessTwoArr[2]).css("display","list-item");
    ...
    singleButton.on( "click", function() {
        $("#pa_harness-size-2nd").val("no-it").change();
    });
    buddyButton.on( "click", function() {
        $("#pa_harness-size-2nd").val("sm-it").change();
    });
