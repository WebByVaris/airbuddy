...
// DIVER SETUP        
    ...
    var singleDescription = $(".airBuddySingle");
    var buddyDescription = $(".airBuddyBuddy");
    var comboDescription = $(".airBuddyCombo");
    var duoDescription = $(".airBuddyDuo");
    ...
    function applyDiverSetupUI() {
        ...
        var setup = diverDescription.prev("select").val();
        ...
        if (setup === "single") {
            ...
            duoDescription.css("display","block");
        }
    }
    ...
    diverDescription.prev("select").on("change", function() {
        scheduleApplyDiverSetupUI();
